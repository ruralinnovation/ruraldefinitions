...
cori.data.s3::put_s3_object("ruraldefinitions", "clean/ruca_2000.parquet", file_path = parquet_buffer)

csv_buffer <- tempfile()
readr::write_csv(ruca_clean, csv_buffer)
cori.data.s3::put_s3_object("ruraldefinitions", "download/ruca_2000.csv", file_path = csv_buffer)
